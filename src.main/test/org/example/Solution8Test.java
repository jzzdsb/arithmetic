...
/*
    ...
    public boolean compare(int a, int b) {
        ...
        while (index < chara.length || index < charb.length) {
            if (index >= chara.length) {
                if (charb[index] > chara[0]) return false;
                index++;
            } else if (index >= charb.length) {
                if (chara[index] > charb[0]) return true;
                index++;
            } else {
